      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div>
          ...
          <input
            ...
            className="w-full rounded-md bg-brand-hover px-3 py-2 text-sm text-white placeholder-brand-text focus:outline-none focus:ring-2 focus:ring-brand-primary"
          />
        </div>
