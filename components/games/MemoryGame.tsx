...
import { HiStar, HiRefresh, HiCheck, HiMusicNote, HiHashtag, HiArrowLeft } from 'react-icons/hi'
  ...
  if (gameOver) {
    return (
      ...
      >
        ...
        <h2 className="text-4xl font-black text-white mb-2 italic uppercase">MÉMORIA AFIADA!</h2>
        <p className="text-spotify-text text-lg mb-8 uppercase tracking-widest font-bold opacity-40">Pares encontrados em {attempts} tentativas.</p>
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
            ...
            >
                <HiRefresh className="h-6 w-6" /> RECOMEÇAR
            </button>
            <button
        ...
        <div className="w-full max-w-2xl">
          <GameLeaderboard gameId="memory" songId="musical-memory-classic" onReset={fetchCards} />
        </div>
      </motion.div>
    )
  }
