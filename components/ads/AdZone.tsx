    ...
    <div className={`flex flex-col items-center justify-center py-2 px-1 overflow-hidden min-h-[60px] w-full ${className}`}>
      ...
      <div className="relative w-full flex justify-center items-center overflow-hidden">
        <div 
          ...
          style={{ 
            width: typeof window !== 'undefined' && window.innerWidth < 768 && mobileZoneKey ? '320px' : activeFormat === '728x90' ? '728px' : activeFormat === '468x60' ? '468px' : '300px',
            height: typeof window !== 'undefined' && window.innerWidth < 768 && mobileZoneKey ? '50px' : activeFormat === '728x90' ? '90px' : activeFormat === '468x60' ? '60px' : '250px',
